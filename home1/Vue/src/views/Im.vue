<template>
  <el-card style="width:920px;min-height: 1000px;background-color: #FEFDFD">
    <div style="padding: 10px; margin-bottom: 50px">
      <el-row>
        <el-col :span="4">
          <div style="width: 230px; height: 300px; color: #333">
        ...
        <el-col :span="20">
          <div style="width: 600px; margin: 0 0 0 120px; background-color: white;
  ...
  methods: {
    send() {
      ...
      if (!this.text) {
        ...
        if (typeof (WebSocket) == "undefined") {
          ...
          console.log("您的浏览器支持WebSocket111");
          // 组装待发送的消息 json
    ...
    init() {
      ...
      if (typeof (WebSocket) == "undefined") {
        ...
        let socketUrl = "ws://localhost:8887/imserver/" + username;
        if (socket != null) {
          socket.close();
          socket = null;
        }
